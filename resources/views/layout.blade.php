                                                    ...
                                                    <div class="m-dropdown__content">
                                                        <ul class="m-nav">
                                                            ...
                                                            <li class="m-nav__item">
                                                                ...
                                                                <a href="{{ url('patients?redirect=patients') }}" class="m-nav__link">
                                                                    <i class="m-nav__link-icon flaticon-users"></i>
                                                                    <span class="m-nav__link-text">افزودن پرونده</span>
                                                                </a>
                                                                @endif
                                                            </li>
                                                            <li class="m-nav__item">
                                ...
                                <div class="m-stack__item m-topbar__nav-wrapper">
                                    <ul class="m-topbar__nav m-nav m-nav--inline">
                                        ...
                                        <li class="m-nav__item m-topbar__quick-actions m-dropdown m-dropdown--skin-light m-dropdown--large m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push m-dropdown--mobile-full-width m-dropdown--skin-light" m-dropdown-toggle="click">
                                            <a href="#" class="m-nav__link m-dropdown__toggle">
                                                <span class="m-nav__link-icon">
                                                    <span class="m-nav__link-icon-wrapper"><i class="fa fa-history"></i></span>
                                                    <span id="in-release" class="m-nav__link-badge m-badge m-badge--brand"></span>
                                                </span>
                                            </a>
                                            <div class="m-dropdown__wrapper" style="margin-left: -150px !important;">
                                                <span class="m-dropdown__arrow m-dropdown__arrow--center"></span>
                                                <div class="m-dropdown__inner" style="height: 600px; overflow: scroll;">
                                                    <div class="m-dropdown__header m--align-center">
                                                        <h5>بیماران ترخیص شده</h5>
                                                        <hr>
                                                        <div id="release">
                                        ...
                                        <li class="m-nav__item m-topbar__notifications m-dropdown m-dropdown--large m-dropdown--arrow m-dropdown--align-center  m-dropdown--mobile-full-width" m-dropdown-toggle="click" m-dropdown-persistent="1">
                                            <a href="#" class="m-nav__link m-dropdown__toggle" id="m_topbar_notification_icon">
                                                <span class="m-nav__link-icon">
                                                    <span class="m-nav__link-icon-wrapper"><i class="fa fa-syringe"></i></span>
                                                    <span id="in-therapist" class="m-nav__link-badge m-badge m-badge--success"></span>
                                                </span>
                                            </a>
                                            <div class="m-dropdown__wrapper" style="margin-right: -200px !important;">
                                                <span class="m-dropdown__arrow m-dropdown__arrow--center"></span>
                                                <div class="m-dropdown__inner">
                                                    <div class="m-dropdown__header m--align-center">
                                                        <h5 class="">خدمات کلینیکی</h5>
                                                        <hr>
                                                        <div id="therapist">
                                        ...
                                        <li class="m-nav__item m-topbar__user-profile  m-dropdown m-dropdown--medium m-dropdown--arrow  m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" m-dropdown-toggle="click">
                                            <a href="#" class="m-nav__link m-dropdown__toggle">
                                                <span class="m-topbar__userpic">
                                                    <img src="{{ url('assets/doctor.png') }}" class="m--img-rounded m--marginless m--img-centered" alt="" />
                                                </span>
                                                    ...
                                                    <div class="m-dropdown__header m--align-center">
                                                        <div class="m-card-user m-card-user--skin-light">
                                                            <div class="m-card-user__pic">
                                                                <img src="{{ url('assets/doctor.png') }}" class="m--img-rounded m--marginless" alt="" />
                                                            </div>
                    ...
                    <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-light m-aside-menu--submenu-skin-light " m-menu-vertical="1" m-menu-scrollable="0" m-menu-dropdown-timeout="500">
                        <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
                            @if(\DB::table('permission_roles')->where('role_id', \Session::get('role'))->where('permission_id', 1)->count() == 1)
                                ...
                                <li class="m-menu__item" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="{{ url('receptions') }}" class="m-menu__link"><i class="m-menu__link-icon fa fa-users"></i><span class="m-menu__link-text">پذیرش</span><i
                                         class="m-menu__ver-arrow"></i></a>
                            ...
                            @endif    
                            @if(\DB::table('permission_roles')->where('role_id', \Session::get('role'))->where('permission_id', 4)->count() == 1)
                                <li class="m-menu__item" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="{{ url('medicines') }}" class="m-menu__link"><i class="m-menu__link-icon fa fa-file-medical"></i><span class="m-menu__link-text">بانک دارو</span><i
                                         class="m-menu__ver-arrow"></i></a>
                                ...
                                <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
                                    <ul class="m-menu__subnav">
                                        ...
                                        @if(\DB::table('permission_roles')->where('role_id', \Session::get('role'))->where('permission_id', 6)->count() == 1)
                                            ...
                                            <li class="m-menu__item " aria-haspopup="true" m-menu-link-redirect="1"><a href="{{ url('fund/doctors-detail') }}" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">صندوق به تفکیک پزشک</span></a></li>

                                            <li class="m-menu__item " aria-haspopup="true" m-menu-link-redirect="1"><a href="{{ url('fund/services-detail') }}" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">صندوق به تفکیک خدمات</span></a></li>
                            ...
                            @if(\DB::table('permission_roles')->where('role_id', \Session::get('role'))->where('permission_id', 10)->count() == 1)
                                <li class="m-menu__item" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="{{ url('return') }}" class="m-menu__link"><i class="m-menu__link-icon fa fa-history"></i><span class="m-menu__link-text">ارجاع پرونده به پزشک همکار</span><i
                                         class="m-menu__ver-arrow"></i></a>
                                    
                                </li>
                            @endif
                            
                            @if(\DB::table('permission_roles')->where('role_id', \Session::get('role'))->where('permission_id', 14)->count() == 1)    
                                ...
                                <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon fa fa-comments"></i><span class="m-menu__link-text">ارسال پیامک</span><i
                                    ...
                                    <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
                                        <ul class="m-menu__subnav">
                                            ...
                                            <li class="m-menu__item " aria-haspopup="true"><a href="{{ url('premium') }}" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">ارسال پیامک تعطیلی مطب</span></a></li>
                            ...
                            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon fa fa-users"></i><span class="m-menu__link-text">مدیریت کاربران</span><i
                                     class="m-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
                                    <ul class="m-menu__subnav">
                                        <li class="m-menu__item " aria-haspopup="true" m-menu-link-redirect="1"><a href="{{ url('roles') }}" class="m-menu__link"><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">نقش ها</span></a></li>
                                        <li class="m-menu__item " aria-haspopup="true"><a href="{{ url('permissions') }}" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">اعطای دسترسی</span></a></li>
                                        <li class="m-menu__item " aria-haspopup="true" m-menu-link-redirect="1"><a href="{{ url('users') }}" class="m-menu__link"><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">کاربران سیستم</span></a></li>
