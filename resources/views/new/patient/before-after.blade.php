...
<div class="kt-portlet kt-portlet--mobile">
							...
							@if ($errors->any())
									...
									@endif	
								{!! Form::open(['action' => ['PatientController@beforeAfter', $patient->id], 'class' => 'kt-form kt-form--label-right','files' => true]) !!}
								...
								<div class="kt-portlet__body" id="append">
									<div class="form-group row" id="clone">
										...
										<div class="col-lg-3">
											...
											{!! Form::select('file_type',['before' => 'before', 'after' => 'after'],null,['class' => 'form-control m-input','id' => 'file_type_id']) !!}
										</div>
										...
										<div class="kt-form__actions">
												<div class="row">
													<div class="col-lg-6">
															...
															<button type="submit" class="btn btn-primary">@if(isset($model))به روزرسانی پرونده @else ثبت  @endif</button>
								...
								<table class="table table-bordered" style="font-size: 18px;">
									...
									@foreach($files as $row)	
										<tr align="center">
											...
											<td>
												{{ \Morilog\Jalali\CalendarUtils::strftime('Y-m-d', strtotime($row->date)) }}
											</td>
											<td>
											...
											<td>
												<a href="{{ url('before-after-files/delete/'.$row->id) }}" onclick="return confirm('هل أنت واثق؟؟');" class="btn btn-warning">حذف</button>
											</td>
										</tr>
									@endforeach	
									</tbody>
