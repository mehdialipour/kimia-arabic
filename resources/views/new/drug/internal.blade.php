                                                ...
                                                <table  class="table table-striped table-bordered table-hover table-checkable" id="storage-table">
													...
													<tbody>
														...
														<tr align="center">
															...
															<td>
																@if(\DB::table('permission_roles')->where('role_id', \Session::get('role'))->where('permission_id', 41)->count() == 1)
																<a class="btn btn-warning" onclick="window.open('{{ url('storage/transfer-to-shelf/'.$row->id) }}',null,'height=900,width=700,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=no,menubar=no,location=no,directories=no, status=no');"> انتقال</a>
																@endif
															</td>
														</tr>
														@endforeach
