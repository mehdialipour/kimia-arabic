						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="m-portlet m-portlet--tab">
									...
									<!--begin::Form-->
										{!! Form::open(['action' => ['PatientController@answers', $id], 'class' => 'm-form m-form--fit m-form--label-align-right']) !!}
										...
										<div class="m-portlet__body">	
											<div class="form-group m-form__group">
												...
												@else
												<?php $question = "question_".$row->id; ?>
													<input type="text" class="form-control m-input" name="question_{{ $row->id }}" value="{{ $answers->$question }}">
												@endif
										...
										<div class="m-portlet__foot m-portlet__foot--fit">
											<div class="m-form__actions">
												<button type="submit" class="btn btn-primary">به روزرسانی پرسشنامه</button>
