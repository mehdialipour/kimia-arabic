									...
									@endif		
										<div class="m-portlet__body">	
											<div class="form-group m-form__group">
												<label for="">عنوان نوع فایل</label>

												{!! Form::text('type', null, ['class' => 'form-control m-input', 'placeholder' => 'نام نوع فایل']) !!}
											</div>
											
										</div>
										<div class="m-portlet__foot m-portlet__foot--fit">
											<div class="m-form__actions">
												<button type="submit" class="btn btn-primary">@if(isset($model))به روزرسانی نوع فایل @else ثبت نوع فایل @endif</button>
											</div>
										</div>
									</form>
